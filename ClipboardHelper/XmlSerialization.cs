//used almost unmodified from:http://blog.danskingdom.com/saving-and-loading-a-c-objects-data-to-an-xml-json-or-binary-file/
...
namespace ClipboardHelperRegEx
{
    ...
    ///     <para>Object to be serialized must have a parameter less constructor.</para>
    /// </summary>
    public static class XmlSerialization
    {
        ...
        public static T ReadFromXmlFile<T>(string filePath) where T : new()
        {
            ...
            var read = XmlReader.Create(reader);
            try
            {
